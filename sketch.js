...
function setup() {
  var ismobile=/iPod|iPad|iPhone|Android/i.test(navigator.userAgent)
  if(ismobile){
    canW=displayWidth
    canH=displayHeight
  ...
  ballon.position(100,250);
  ballon.size(100,100);
  ballon.mouseClicked(Hforce);


  rope = new Rope(7,{x:245,y:30});
  rope2 = new Rope(7,{x:400,y:30});
  rope3 = new Rope(7,{x:120,y:50});
